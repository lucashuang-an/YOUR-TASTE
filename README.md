...
3. **Synthesize** — Turn those findings into **YOUR-TASTE**, a small design system: cool paper ground, sparse terracotta accent, cerulean for information, hard-edge layout, limited typefaces (Songti / PingFang / Georgia / Segoe UI / Consolas).
...
3. **成系统** — 得到 **YOUR-TASTE** 设计系统：冷纸底、稀疏赤陶强调、冷蓝信息色、硬边版式、字体中英各不超过 3 种。
